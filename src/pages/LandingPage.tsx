...
export default function LandingPage() {
    ...
    // Check for demo=true query parameter on mount to open the demo modal
    useEffect(() => {
        ...
        <div className="landing-page">
                    ...
                    <div className="pricing-grid">
                        {pricingPlans.map((plan) => (
                            <div key={plan.name} className={`pricing-card${plan.highlighted ? ' highlighted' : ''}`} data-animate={`pricing-${plan.name}`}>
                                ...
                                <div className="pricing-price" style={{ margin: '16px 0 24px 0', display: 'block' }}>
                                    <span className="pricing-value" style={{ fontSize: '24px', letterSpacing: '-0.02em', color: 'var(--orca-accent)' }}>Sob Consulta</span>
                                </div>
                                ...
                                <button 
                                    ...
                                    style={{ textAlign: 'center', display: 'block', width: '100%', border: 'none', cursor: 'pointer' }}
                                >
                                    Agendar demonstração
                                </button>
                                <p className="pricing-guarantee">Apresentação personalizada sem compromisso</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="float-actions">
                ...
                <div className="float-contact">
                    ...
                    <a href="https://wa.me/351927501399?text=Olá%2C%20quero%20conhecer%20a%20ORCA" target="_blank" rel="noopener">
